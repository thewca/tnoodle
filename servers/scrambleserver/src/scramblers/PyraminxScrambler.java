...
public class PyraminxScrambler extends ScrambleImageGenerator {
	...
	static {
		defaultColorScheme.put("F", ScrambleUtils.toColor("ff0000"));
		defaultColorScheme.put("D", ScrambleUtils.toColor("0000ff"));
		defaultColorScheme.put("L", ScrambleUtils.toColor("00ff00"));
		defaultColorScheme.put("R", ScrambleUtils.toColor("ffff00"));
	}

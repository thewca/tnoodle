...
//	}
	...
	static {
		defaultColorScheme.put("L", ScrambleUtils.toColor("ffff00"));
		defaultColorScheme.put("B", ScrambleUtils.toColor("ff0000"));
		defaultColorScheme.put("R", ScrambleUtils.toColor("0000ff"));
		defaultColorScheme.put("F", ScrambleUtils.toColor("ffc800"));
		defaultColorScheme.put("U", ScrambleUtils.toColor("ffffff"));
		defaultColorScheme.put("D", ScrambleUtils.toColor("00ff00"));
	}
	@Override

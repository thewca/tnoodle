...
enum class FormatData(val key: String, val description: String, val tag: String, val numSolves: Int) {
    ...
    companion object {
        ...
        val FULL_BLD_FORMATS = sortedSetOf(BEST_OF_3, BEST_OF_2, BEST_OF_1)
        val THREE_BLD_FORMATS = sortedSetOf(BEST_OF_5, BEST_OF_3)
        val BIG_BLD_FORMATS = sortedSetOf(BEST_OF_3)

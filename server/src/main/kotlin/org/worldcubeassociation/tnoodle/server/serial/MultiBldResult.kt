...
import org.worldcubeassociation.tnoodle.core.model.wcif.AttemptResult
import org.worldcubeassociation.tnoodle.core.serial.DurationSecondsSerializer
...
data class MultiBldResult(val solved: Int, val attempted: Int, val time: @Serializable(with = DurationSecondsSerializer::class) Duration) {
    ...
    companion object {
        ...
        val AttemptResult.asMultiResult

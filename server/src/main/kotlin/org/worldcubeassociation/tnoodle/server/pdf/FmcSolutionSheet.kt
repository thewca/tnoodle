...
import org.worldcubeassociation.tnoodle.core.model.pdf.Table
...
import org.worldcubeassociation.tnoodle.core.model.pdf.dsl.PageBuilder
import org.worldcubeassociation.tnoodle.core.model.pdf.dsl.TableBuilder
...
import org.worldcubeassociation.tnoodle.core.model.pdf.properties.Paper.inchesToPixel
import org.worldcubeassociation.tnoodle.core.model.pdf.properties.Paper.inchesToPixelPrecise
import org.worldcubeassociation.tnoodle.core.model.pdf.properties.Paper.pixelsToInch
...
import org.worldcubeassociation.tnoodle.server.pdf.util.DslUtil.optimalLine
import org.worldcubeassociation.tnoodle.server.pdf.util.DslUtil.optimalText
import java.util.*
        ...
        row {
            cell {
                ...
                evenParagraph {
                    ...
                    val registrantIdDesc = Translate(
                        "fmc.registrantId",
                        locale
                    ) + SHORT_FILL
        ...
        row {
            cell {
                ...
                if (drawScramble) {
                    ...
                    val separateSheetAdvice =
                        Translate("fmc.scrambleOnSeparateSheet", locale)

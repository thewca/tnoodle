...
abstract class FmcSheet(scrambleSet: ScrambleSet, activityCode: ActivityCode, val competitionTitle: String, val locale: Locale) : BaseScrambleSheet(scrambleSet, activityCode) {

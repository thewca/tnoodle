...
describe('async actions', () => {
  ...
  it('generateMissingScrambles', () => {
    xhrMock.get("http://localhost/scramble/json?standard-sheet=333*7&showIndices=0", (req, res) => {
      return res
        .status(200)
    ...
    xhrMock.get("http://localhost/scramble/json?standard-sheet=333ni*40&showIndices=1", (req, res) => {
      return res
        .status(200)
        .header('Content-Type', 'application/json')

...
public class TNoodleServer {
    ...
    public TNoodleServer(int httpPort, boolean bindAggressively, boolean browse) throws IOException {
    ...
    private static void setApplicationIcon() {
        ...
        if (processType == Launcher.PROCESS_TYPE.WORKER) {
        ...
        if (isOSX()) {
            ...
            if (!iconFileName.equals(ICON_WORKER)) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        OptionSpec<?> noReexecOpt = parser.acceptsAll(Collections.singletonList(Launcher.NO_REEXEC_OPT),

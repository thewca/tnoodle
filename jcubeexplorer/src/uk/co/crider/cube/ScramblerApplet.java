 ...
 * Description: Applet for generating random-state scrambles with
 * Herbert Kociemba's Java implementation of the two-phase algorithm 
*/
...
import uk.co.crider.cube.ScrambleCacher.ScrambleCacherListener;
...
public class ScramblerApplet extends JApplet implements ScrambleCacherListener {
	...
	// Returns a random-state scramble sequence. Called by javascript 
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 2; i++) {
			...
			String rCube = Tools.randomCube(rand);

...
import org.worldcubeassociation.tnoodle.server.pdf.model.dsl.DocumentBuilder
import org.worldcubeassociation.tnoodle.server.pdf.model.dsl.PageBuilder
...
import org.worldcubeassociation.tnoodle.server.pdf.model.properties.Paper.inchesToPixel
import org.worldcubeassociation.tnoodle.server.pdf.model.properties.Paper.pixelsToInch
            ...
            repeat(SCRAMBLES_PER_SHEET) {
                row {
                    ...
                    cell {
                        ...
                        val scrambleWidthPx = (scrambleWidth * actualWidthIn).inchesToPixel - paddingBackoff(
                            SCRAMBLE_IMAGE_PADDING
                        )
                        val scrambleHeightPx = (relHeightPerScramble * actualWidthIn).inchesToPixel - paddingBackoff(
                            SCRAMBLE_IMAGE_PADDING
                        )
